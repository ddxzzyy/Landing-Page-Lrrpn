    ...
    return (
        ...
        >
            ...
            <motion.p
                ...
                className="mt-6 text-sm md:text-base text-white/60 max-w-xl leading-relaxed px-2"
            >
                Rehabilitasi fisik, mental, dan sosial
                dengan pendekatan medis serta
                psikologis yang terintegrasi.
            </motion.p>

            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">

                <a href="#contact" className="group px-7 py-4 rounded-full bg-orange-500 hover:bg-orange-400 transition flex items-center justify-center gap-3 text-sm font-medium">
                    Konsultasi Sekarang
                ...
                <a
                    href="#program"
                    className="px-7 py-4 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 transition text-sm text-white inline-block"
                >
